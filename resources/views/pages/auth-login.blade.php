                        ...
                        <form method="POST" data-parsley-validate >
                            <div class="form-group">
                                ...
                                <input id="email"
                                    ...
                                    name="email"
                                    tabindex="1"
                                    autofocus required data-parsley-errors-container="#email-error" data-parsley-type="email" data-parsley-trigger="change">
                            ...
                            <div class="form-group">
                                ...
                                <input id="password"
                                    ...
                                    name="password"
                                    tabindex="2"
                                       required data-parsley-errors-container="#password-error" data-parsley-minlength="8" data-parsley-trigger="change">
